...
- Items: fragment page, tome, chronicle, lost ink. Block: lost inscription.
...
counter and mod-item recipes are opt-in; untitled entries all read "some words on something".
