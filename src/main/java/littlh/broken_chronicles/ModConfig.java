...
public final class ModConfig {
    ...
    public static final ModConfigSpec.BooleanValue READING_ONLY = BUILDER
            .comment("只保留阅读：一个开关顶下面六件物品，给「只想要在物品栏里读文字」的整合包用。",
                    "开启后，破碎编年史 / 破碎残片 / 破碎残册 / 失传墨水 / 失传铭刻 和抄写配方一律当作关闭：",
                    "它们不出现在创造模式物品栏（也不留空白标签页），不能使用、合成、掉落，收集与收录一并停止，",
                    "收集类成就也不再出现；阅读本身照常——右键、阅读键、背包界面里悬浮按阅读键都能打开文字。",
                    "等于一键把下面六项全按掉，下面六项写什么都不再看。",
                    "想恢复某项时把这一项关掉，下面六项各自恢复生效。")
            .define("readingOnly", false);
