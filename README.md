...
- **The items** — *Fragment Chronicle* (破碎编年史, the journal itself: paper + feather + any enchanted book), *Broken Fragment*, *Broken Tome*, *Lost Ink* (失传墨水) and the *Lost Inscription* (失传铭刻) block. Everything a player can touch sits in the mod's own creative tab, also titled **Fragment Chronicle**.
